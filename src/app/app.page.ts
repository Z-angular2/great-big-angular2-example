...
export class AppPage {
  ...
  closeSidenav() {
     ...
     * application.
     */
    this.store.dispatch(new actions.Update(slices.LAYOUT, ['booksPage', 'showSidenav'], false));
  }

  openSidenav() {
    this.store.dispatch(new actions.Update(slices.LAYOUT, ['booksPage', 'showSidenav'], true));
  }
